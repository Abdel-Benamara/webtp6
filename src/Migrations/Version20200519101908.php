 ...
 */
final class Version20200519101908 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE especePokemon CHANGE id id INT AUTO_INCREMENT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE especePokemon CHANGE id id INT NOT NULL');
    }
}
