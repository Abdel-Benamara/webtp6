...
(1, 'admin@mail.com', '[\"ROLE_ADMIN\"]', '$2y$13$A1zWmjgaoxXOC0oUe0ccROgQAzscqxdITDwsCPA8lz7Dvc8bdTjLy', 55000);
...
INSERT INTO `pokemon` (`id`, `surnom`, `idDresseur`, `idEspece`, `xp`, `niveau`, `sexe`, `prix`) VALUES
(1, 'Lulu', 1, 1, 0, 1, 'mâle', 0);
...
--
-- Hôte : localhost:8889
-- Généré le :  mar. 19 mai 2020 à 09:57
-- Version du serveur :  5.7.26
-- Version de PHP :  7.4.2
...
--
-- Base de données :  `symfony-pokegame`
--
...
INSERT INTO `pokemon` (`id`, `nom`, `courbeXP`, `evolution`) VALUES
(1, 'Bulbizarre', 'P', 'n'),
(2, 'Herbizarre', 'P', 'o'),
(3, 'Florizarre', 'P', 'o'),
(4, 'Salamèche', 'P', 'n'),
...
--
-- Structure de la table `typePoke`
--
...
--
-- Déchargement des données de la table `typePoke`
--

INSERT INTO `typePoke` (`id`, `type`) VALUES
(1, 'Acier'),
(2, 'Combat'),
(3, 'Dragon'),
(4, 'Eau'),
...
--
-- AUTO_INCREMENT pour la table `typePoke`
--
ALTER TABLE `typePoke`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
